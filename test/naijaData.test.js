...
describe("Authenticated Naija Endpoints", ()=>{
        it("should return the full data, when an authenticated user provides their valid Api Key", async()=>{
        ...
        //  expect(body).toHaveProperty("nigeriaData");
        });
